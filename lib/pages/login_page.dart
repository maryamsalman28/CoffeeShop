...
import 'shop_page.dart'; // Import your shopping page
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 20),
                  Text(
                    'Welcome to Coffee Cove, Please Login',
                    style: TextStyle(
                      fontSize: 30,
                  ...
                  SizedBox(height: 20),
                  // Login Form Fields (e.g., Username, Password)
                  TextField(
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: Color.fromARGB(255, 144, 111, 77), // Background color brown
